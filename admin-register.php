...
if(isset($_POST['btn-register'])){
	...
	$password = $MySQLi_CON->real_escape_string(trim($_POST['password']));
		...
		if ($count==0) {
			$query = "INSERT INTO student1(full_name,reg_no,email,password) VALUES('$full_name','$reg_no','$email',$password')";
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<form method="post" id="register-form">
						...
						<div class="col-md-8 col-md-offset-2 form-group">
								...
								<input type="password" class="form-control login-field" name="password" placeholder="Enter your password" id="login-no" required />
							<span class="help-block " id="error"></span>
