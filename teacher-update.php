	...
	header("Location: teacher-login.php");
		...
		$query = $MySQLi_CON->query("SELECT * FROM student WHERE tsc_no ='$_SESSION[studentSession]'");
          ...
          if (isset($_POST['btn-update'])) {
          	...
          	$updateQuery1 = "UPDATE student SET subject1='$subject1' WHERE tsc_no='$_SESSION[studentSession]'";
          	$updateQuery2 = "UPDATE student SET subject2='$subject2' WHERE tsc_no='$_SESSION[studentSession]'";
          	$updateQuery3 = "UPDATE student SET subject3='$subject3' WHERE tsc_no='$_SESSION[studentSession]'";
          	$updateQuery4 = "UPDATE student SET subject4='$subject4' WHERE tsc_no='$_SESSION[studentSession]'";
...
if(mysqli_query($MySQLi_CON,$updateQuery3)){
			...
			header("refresh:4;teacher-account.php");
...
<body>
	<h1>Update your teaching subjects</h1>

	<h2 Name: <?php echo $row['full_name']; ?></h2> <span>Gender: <?php if($row['gender']=='') {echo 'Uknown';} else { echo $row['gender']; }?></h2>
	<h3 class="text-primary">Email: <?php echo $row['email']; ?></h3>
	<h3 class="text-primary">tsc_no: <?php echo $row['tsc_no']; ?></h3> 
	...
	<form method="post">
		<div class="container">
			<div class="form-group col-md-6 col-md-offset-3">
				...
				<input type="number" class="form-control " name="tsc_no" value="<?php echo $row['tsc_no']; ?>" readonly/>
				...
				<span><a href="teacher-account.php">Home</a></span>
			</div ><br>
